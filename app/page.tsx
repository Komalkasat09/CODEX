...
import { HandMetal, BookOpen, Phone, Users, Globe, Brain, ChevronRight, Sparkles, Trophy, MessageSquare, Gauge, ArrowRight, AlertTriangle } from "lucide-react"
...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Send emergency alerts via WhatsApp to your contacts. Quick access to help when you need it most with instant messaging.",
      href: "/dashboard/call",
      stats: { value: 5000, label: "Emergency Alerts" },
      achievements: ["Instant", "Reliable"],
      progress: 98,
      progressLabel: "Message Delivery Rate"
    }
  ]
